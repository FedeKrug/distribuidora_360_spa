                ...
                <div className="flex flex-wrap ">
                    <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
                        <div className="relative lg:max-w-md">
                            ...
                            <div
                                className="absolute bottom-0 right-0 z-10 p-8 bg-white border-4 border-yellow-500 rounded shadow dark:border-yellow-400 lg:-mb-8 lg:-mr-11 sm:p-8 dark:text-gray-300 dark:bg-gray-800 ">
                                <p className="text-lg font-semibold md:w-72">
                                    ...
                                    </svg> Trabajamos con más de 20 ferreterías a lo largo del país.
                                </p>
                            </div>
                        </div>
                    </div>
